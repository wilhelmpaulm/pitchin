            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#"><span class="c-amethyst"><i class="glyphicon glyphicon-search"></i> VIEW EVENTS</span></a></li>
                        <li><a href="{{URL::to('me/events')}}"><span class="c-greensea"><i class="glyphicon glyphicon-calendar"></i> MY EVENTS</span></a></li>
